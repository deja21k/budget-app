...
class ReceiptService {
    ...
    `);
        const result = stmt.run(input.transaction_id || null, input.image_path, input.ocr_text || null, input.ocr_confidence || null, input.extracted_merchant || null, input.extracted_amount || null, input.extracted_date || null, input.status || 'processing');
