...
export class OCRService {
   ...
   */
  private validateImage(imageBuffer: Buffer): { valid: boolean; error?: string } {
   ...
   */
  async validateImageOnly(imageBuffer: Buffer): Promise<{ valid: boolean; error?: string }> {
   ...
   */
  getHealth(): { status: string; config: typeof OCR_CONFIG } {
    return {
      status: 'ready',
      config: { ...OCR_CONFIG },
    };
