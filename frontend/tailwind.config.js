  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'soft-xl': '0 25px 50px -12px rgba(0, 0, 0, 0.1), 0 40px 60px -15px rgba(0, 0, 0, 0.05)',
        'glow': '0 0 20px rgba(99, 102, 241, 0.3)',
        'glow-lg': '0 0 40px rgba(99, 102, 241, 0.4)',
        'inner-glow': 'inset 0 2px 4px 0 rgba(255, 255, 255, 0.3)',
        'premium': '0 4px 6px -1px rgba(0, 0, 0, 0.02), 0 2px 4px -1px rgba(0, 0, 0, 0.02), 0 0 0 1px rgba(0, 0, 0, 0.02)',
      ...
      backgroundImage: {
        ...
        'gradient-mesh': 'linear-gradient(to right bottom, rgb(248, 250, 252), rgb(241, 245, 249))',
      },
    },
  },
  plugins: [
